...
## EN CURSO
1. **Pan Berna 10×** — receta dice "1 unidad", stock en bolsa_10: cada hot dog descuenta 10 panes. Método Cheddar: decidir unidad real del producto + factor 0.1 en 4 líneas + verificar costo invariante (hoy costo bien $0.142/pan, deducción mal — mover juntos).
