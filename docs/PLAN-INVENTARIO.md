...
## EN CURSO
1. ✅ **3 panes recableados a bolsa** — HECHO 25-ago, migración `recablear_panes_bolsa_factor_a_stock`: Hot Dog Brioche (3 recetas → bolsa 12, factor 1/12), Hot Dog Berna (4 recetas → bolsa 10, factor 1/10), Hamburguesa Brioche (4 recetas → bolsa 12, factor 1/12). 11 líneas total. Superfreak renombrado a "Pan de Hot Dog Brioche bolsa 12" y activado. Unitarios sacados del conteo. El enfoque del 23-ago (etiqueta bolsa_10→unidad) queda superado: ahora el inventario vive en bolsas como dicta la arquitectura 22-ago.
