...
- **Además:** PR #243 (Libros Contables) **mergeado a main** — verificado que el squash solo llevó los 5 archivos propios; build verde. Y el reporte de Ángel quedó con ambas columnas (Venta Gravada con IVA y neta).
